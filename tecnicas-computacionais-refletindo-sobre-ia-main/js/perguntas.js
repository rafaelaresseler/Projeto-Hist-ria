export const perguntas = [
    {
        enunciado: " Chegando ao parque seu olho começa a doer pois o sol estava muito forte, e acabou ficando com um mal estar e esbarrou em um garoto. O que ela deve fazer?",
        alternativas: [
            {
