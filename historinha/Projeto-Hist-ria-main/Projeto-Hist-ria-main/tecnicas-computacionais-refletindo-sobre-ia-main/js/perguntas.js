export const perguntas = [
    {
        enunciado: " Chegando ao parque seu olho começa a doer pois o sol estava muito forte, acabou ficando com um mal estar e esbarrou em um garoto. O que ela deve fazer?",
        alternativas: [
            {
                texto: "Ela deve se desculpar?",
                afirmacao: [
                    "Ela se desculpou com um leve sorriso de canto",
                    "E o garoto ficou rindo da cara dela"
                ],
                proxima: 1,
            },
            {
                texto: "Ou deve sair correndo?",
                afirmacao: [
                    "Ela saiu correndo olhando para trás",
                    "Quando foi olhar para frente acabou tropeçando em seu próprio pé"
                ],
                proxima: 2,
            },
        ]
    ...
    {
        enunciado: "O garoto era alto e estava usando uma roupa MUITO chamativa, com isto ficou pensando nele",
        alternativas: [
            {
                texto: "Ela deve ir atrás dele ?",
                afirmacao: [
                    "",
                    "Ela fica horas e horas à procura dele",
                    "Quando ela o encontra ele está com uma outra garota"
                ],
                proxima: 3,
            },
            {
                texto: "Ou curtir o parque?",
                afirmacao: [
                    "Ela vai em vários brinquedos legais",
                    "Almoça no parque e toma sorvete",
                    "Se divertiu o restante da tarde"
                ],
                proxima: 4,
            },
        ]
    ...
    {
        enunciado: "A garota passou alguns dias em Orlando ",
        alternativas: [
            {
